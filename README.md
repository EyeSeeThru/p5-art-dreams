...
- **julia-set** — Complex plane fractal visualization z²+c. Different constants c produce different Julia sets (Dendrite, Douady Rabbit, San Marco, etc.). Smooth iteration coloring with orbit trap influence. Mouse pan, scroll zoom, ←→ cycle presets, SPACE animates c slightly, R resets.

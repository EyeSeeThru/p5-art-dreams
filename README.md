...
- **forged-in-fire** — Glowing molten metal shaped by extreme heat. Flowing orange-red rivulets cascade and pool, white-hot streaks cut through the darkness. Sparks drift upward from the forge. Deep blacks give way to deep red, then orange, then white-yellow heat at the brightest points. The transformation of raw metal through fire — raw, brutal, powerful. Click to add sparks. Different from blood-iron (cold oxidation/rust) — this is active heat, the moment of creation, molten and alive. Bright orange-red dominant with dark negative space.
